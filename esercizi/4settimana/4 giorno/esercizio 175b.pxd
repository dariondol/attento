Experiment()
{
  Context()
  {
    AssignmentGroup()
    {
      ExperimentName = "Cerca la lettera 'z'";
      HideCursor = 0;
    ...
    Session()
    {
      Instruction()
      {
        Text = lang2(["Cerca la lettera 'z' in mezzo alle lettere 's'",
		" ",
		"Premi il tasto sinistro del mouse se tra le lettere 's' vedi la lettera 'z' e premi il tasto destro se non la vedi.",
		" ",
