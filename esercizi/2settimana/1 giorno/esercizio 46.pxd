  ...
  Context() {
    ...
    Session:Acoustic(SignalType) {
      Instruction() {
		...
		" ",
		"Vedrai una croce seguita da un suono. Premi il tasto del mouse piu' velocemente possibile appena senti il suono.", 
		" ",
		"Press any key to startPREMI UN TASTO PER INIZIARE!"],
