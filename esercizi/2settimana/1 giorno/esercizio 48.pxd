  ...
  Context()
  {
    ...
    Session()
    {
      Instruction()
      {
		...
		"Successivamente vedrai due lettere e devi selezionare quella che era presente nella parola apparsa prima (o individuare la lettera comparsa prima).", 
	...
	CueDelayTimer = de.pxlab.pxl.TimerCodes.VS_CLOCK_TIMER;
        ...
        CueSize = idiv(screenWidth(),60);
        CueDistance = idiv(screenWidth(), 5);
